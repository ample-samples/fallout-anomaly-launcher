  ...
  return (
    <>
      <div className="h-full flex flex-row">
        <div className="flex flex-col gap-[2px] font-Overseer text-xl text-white relative p-4 w-56 pb-8 justify-end bg-[#000000cc]">
          <p className="w-full text-3xl hover:text-black hover:bg-white px-4 mb-1">
